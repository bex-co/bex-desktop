...
actions!(
    cli,
    [
        /// Installs the Bex CLI tool to the system PATH.
        InstallCliBinary,
    ]
);
...
pub fn install_cli_binary(window: &mut Window, cx: &mut Context<Workspace>) {
    const LINUX_PROMPT_DETAIL: &str = "If you installed Bex from our official release add ~/.local/bin to your PATH.\n\nIf you installed Bex from a different source like your package manager, then you may need to create an alias/symlink manually.\n\nDepending on your package manager, the CLI might be named zeditor, zedit, zed-editor or something else.";
    ...
    .detach_and_prompt_err("Cannot install the Bex CLI", window, cx, |_, _, _| None);
}
