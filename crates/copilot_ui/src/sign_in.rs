    ...
    cx.open_window(
        WindowOptions {
            ...
            titlebar: Some(gpui::TitlebarOptions {
                title: Some("Use GitHub Copilot in Bex".into()),
...
impl CopilotCodeVerification {
    ...
    fn render_prompting_modal(
        ...
        v_flex()
            ...
            .text_center()
            .child(
                Headline::new("Use GitHub Copilot Edit Predictions in Bex")
...
impl CopilotChatCodeVerification {
    ...
    fn render_prompting_modal(
        ...
        v_flex()
            ...
            .items_center()
            .text_center()
            .child(Headline::new("Use GitHub Copilot Chat in Bex").size(HeadlineSize::Large))
            .child(
...
impl ConfigurationView {
    ...
    fn render_for_chat(&self) -> impl IntoElement {
        let start_label = "To use Bex's agent with GitHub Copilot Chat, you need to be logged in to GitHub. Note that your GitHub account must have an active Copilot Chat subscription.";
