...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Bex Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Bex Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Bex Editor Preview Instance Running",
        ReleaseChannel::Stable => "Bex Editor Stable Instance Running",
    }
}
