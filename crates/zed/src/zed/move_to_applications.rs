...
impl MoveToApplicationsRequest {
    ...
    async fn prompt(
        ...
        let response = cx
            .prompt(
                PromptLevel::Info,
                "Move Bex to Applications?",
                Some(
                    "Bex is running from a temporary location. Move it to Applications to finish installing it.",
                ),
                &[
                    PromptButton::ok("Yes"),
            ...
            0 => {
                ...
                if let Err(error) = move_to_applications(&self.app_path, cx).await {
                    ...
                    cx.prompt(
                        ...
                        "Failed to move Bex to Applications",
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .child(Label::new("Installing Bex…")),
            )
            .child(
                h_flex()
                    .w_full()
                    ...
                    .child(
                        v_flex()
                            .gap_1()
                            .child(Label::new("Moving Bex to Applications"))
                            .child(
                                Label::new("Bex will reopen when installation is complete.")
